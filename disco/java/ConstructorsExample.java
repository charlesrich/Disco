...
/* 
   This is a first example demonstrating the use of constructors for constructing a
   task model without XML.  This implementation is still limited and incomplete.
   It is being developed to support work at LIMSI on Discolog.
 */
